...
public class DelInfoAdapter extends SelectionAdapter {
    ...
    public DelInfoAdapter(Group deletionParams, Combo typeOfDel, Client client, TableComponent resultTable) {
    ...
    public void widgetSelected(SelectionEvent e) {
        ...
        List<Student> removedStudents = client.askDelStudentsByParam(firstParam, secondParam, type);
