...
public class SearchInfoAdapter extends SelectionAdapter {
    ...
    public SearchInfoAdapter(Group paramsGroup, Combo type, DataBaseController dataBaseController, TableComponent resultTable) {
    ...
    public void widgetSelected(SelectionEvent e) {
        ...
        List<Student> foundStudents = dataBaseController.findStudentByParam(firstParam, secondParam, type);
